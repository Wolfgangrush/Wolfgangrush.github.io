...
layout: default
title: Tools
description: Single-purpose tools for practitioners — the NAKASHA board reader, samanvaya privacy conformance, offline multi-script OCR, the pseudonymisation gateway, the DPDP Act as runnable code, the Supreme Court AI regulations mapping, a citation manager, a news digest bot, the CHOF human-oversight toolkit, ***REMOVED*** startup-tax pre-screening, and repofacts.
---
...
<div class="mg">
  ...
  <div>
    <div class="tool" id="***REMOVED***">
      <div class="tool-head"><h2>***REMOVED***</h2><span class="badge">For chartered accountants · free</span></div>
...
<pre class="code-block"><code>pip install git+https://github.com/Wolfgangrush/***REMOVED***
***REMOVED***</code></pre>

      <p class="juris-links">
        <a class="btn btn-primary" href="https://github.com/Wolfgangrush/***REMOVED***#readme">Installation guide</a>
        <a class="btn btn-ghost" href="https://github.com/Wolfgangrush/***REMOVED***">Read the source</a>
      </p>
    </div>
  </div>
</div>
